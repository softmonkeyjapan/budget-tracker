...
const classes = computed(() =>
    props.active
        ? 'inline-flex items-center px-1 pt-1 border-b-2 border-nav text-sm font-semibold leading-5 text-ink focus:outline-none transition duration-150 ease-in-out'
